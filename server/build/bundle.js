...
var UsersListPage = function (_PureComponent) {
...
exports.default = function (req) {
    // Strips cookie from origin browser request and assigns it to server side api call
    // which is sent via proxy to destination, therefore allowing auth
...
exports.default = function (req, store) {
    ...
    return '\n        <html>\n            <head></head>\n             <body>\n                <div id="root">' + content + '</div>\n                <script>\n                    window.INIITAL_STATE = ' + (0, _serializeJavascript2.default)(store.getState()) + '\n                </script>\n                <!-- bundle.js is from publicly available \'public\' dir -->\n                <script src="bundle.js"></script>\n            </body>\n        </html>\n    ';
};
